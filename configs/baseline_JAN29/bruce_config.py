...
# left foot initial state: [ 0.00824264  0.46926757 -0.01822493 -0.94714788  0.47781332]
        ...
        default_joint_angles = { # = target angles [rad] when action = 0.0
           ...
           'hip_pitch_r' :  0.46926757,         
           'knee_pitch_r' : -0.94714788,       
           'ankle_pitch_r' : 0.47781332,     
        
           'hip_yaw_l' : 0.00824264, 
           'hip_roll_l' : -0.01822493, 

           'hip_pitch_l' : 0.436332, #'hip_pitch_l' : 0.46926757,                                       
           'knee_pitch_l' : -0.610865, #'knee_pitch_l' : -0.94714788,                                            
           'ankle_pitch_l' : 0.17533, #'ankle_pitch_l' : 0.47781332,                                     
